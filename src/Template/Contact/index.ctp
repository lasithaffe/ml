        ...
        <section class="page-header">
            <div class="page-header__bg004 page-header__bg"></div><!-- /.page-header__bg -->
            ...
            <div class="container">
                <div class="row">
                    <div class="section-title text-center">
                        <h2 class="section-title__title">We would love to hear from you!</h2>
                        <h3>Schedule a free consultation with ManoLead</h3>
